  ...
  <section class="section section--investment">
    ...
    <div class="steps">
      <IntersectionObserver :step="0" :noStyling="true" classes="step step-0">
        ...
        <p>Compared to the average investment volumes observed from 2017–2019, annual average investments over the next 10 years need to be considerably scaled up for achieving ambitious mitigation targets. Currently pledged targets for 2030 (so-called Nationally Determined Contributions, NDC, see <a v-tooltip="{ content: '<p>Senses: Closing the emissions gap</p>'}" href="https://climatescenarios.org/emissions-gap/" target="_blank">emissions gap module</a>) already imply an increase of yearly investments, but cost-efficiently achieving the 2&#8239;°C or even 1.5&#8239;°C target requires an even stronger increase.</p>
        <p>Increased investments don’t imply equally increased costs to consumers. Many of the investments required actually allow for future savings, by limiting energy bills (as in the case of efficiency investments), or by <a v-tooltip="{ content: '<p>Senses: Transition Risks: Power Sector Transformation</p>'}" href="https://climatescenarios.org/power-sector/" target="_blank">providing power generation without fuel costs</a> (as in the case of investments into renewable power generation). The historic situation of high public spending via COVID-19 recovery packages offers a great way of mobilizing such sums, which are only a small percentage of envisioned <a v-tooltip="{ content: '<p>Andrijevic, M., Schleussner, C., Gidden, M. et al. “COVID-19 recovery funds dwarf clean energy investment needs.” Science 16 Oct 2020: Vol. 370, Issue 6514, pp. 298-300.</p>'}" href="https://doi.org/10.1126/science.abc9697" target="_blank">total recovery packages</a>.</p>
      ...
      <IntersectionObserver :step="3" :noStyling="true" classes="step step-3">
        ...
        <p>Electrification is a key mitigation strategy, but for it to be effective, power generation needs to be decarbonized quickly. Therefore, ambitious mitigation scenarios see all sources of low-carbon energy to expand, requiring strongly increasing investments in the next decade.</p>
        <p>The two low-carbon sources standing out however are <Variable variable="wind">Wind</Variable> and <Variable variable="solar">Solar</Variable>: Due to recent cost reductions, they quickly become universally the cheapest form of electricity as soon as CO₂ is priced, and thanks to their granular nature and can be scaled up rapidly in all world regions. </p>
        <BarCompactAbsolute
      ...
      <IntersectionObserver :step="4" :noStyling="true" classes="step step-4">
        ...
        <p>The last but very clearly not the least component of an investment strategy to move towards ambitious climate targets is a considerable increase in investments for <Variable variable="energy-efficiency">Energy Efficiency</Variable>. These investments allow for <a v-tooltip="{ content: '<p>Grubler, Arnulf, Charlie Wilson, Nuno Bento, Benigna Boza-Kiss, Volker Krey, David L. McCollum, Narasimha D. Rao, et al. “A Low Energy Demand Scenario for Meeting the 1.5&#8239;°C Target and Sustainable Development Goals without Negative Emission Technologies.” Nature Energy 3, no. 6 (June 2018): 515–27.'}" href="https://doi.org/10.1038/s41560-018-0172-6" target="_blank">immediate emission reductions</a> of sectors before their energy supply is decarbonized, and also are a crucial component for long-term sustainable energy systems with <a v-tooltip="{ content: '<p>Bertram, Christoph, Gunnar Luderer, Alexander Popp, Jan Christoph Minx, William F. Lamb, Miodrag Stevanović, Florian Humpenöder, Anastasis Giannousakis, and Elmar Kriegler. “Targeted Policies Can Compensate Most of the Increased Sustainability Risks in 1.5&#8239;°C Mitigation Scenarios.” Environmental Research Letters 13, no. 6 (2018): 064038.'}" href="https://doi.org/10.1088/1748-9326/aac3ec" target="_blank">much-reduced sustainability trade-offs</a> inherent to all energy technologies.</p>
        <BarCompactAbsolute
